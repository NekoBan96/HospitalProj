    ...
    <body class="dark:bg-[#002137e5] overflow-x-hidden font-body bg-[#F1F1F1]">
        ...
        <div>
            ...
            <div class="flex flex-col justify-center mb-20">
                <Header></Header>
                <MyInput class="lg:self-start lg:ml-[360px]" v-model="searchQuery"> </MyInput>
            </div>
            <div class="w-screen mb-[30px] flex justify-around items-center">
                <h1 class="text-[35px] font-bold inline dark:text-white ">
                    Аппаратура</h1>
                <div v-show="isAuth">
            ...
            <Modal v-model:show="dialogVisible">
                <div class="flex flex-col justify-center items-center">
                    <div>
                        <h1 class="font-bold text-center">Вы уверены что хотите удалить этот аппарат?</h1>
                    </div>
            ...
            <div class="flex items-center justify-center my-6">
                <div v-for="(page, index) in totalPages" :key="page"
...
const { devices, sortedByRouteIdDevices, currentPage, totalPages, loadDevices, typeOfReq } = useDevices()
