  ...
  <body class="dark:bg-[#002137e5] overflow-x-hidden font-body bg-[#F1F1F1]">
    <div class="flex flex-col">
      ...
      <div class="w-screen flex flex-col items-center">
        <div
          class="lg:space-y-10 flex flex-col lg:w-[1250px] min-h-[800px] w-full"
        >
          <div
            class="flex sm:flex-row flex-col justify-between items-center space-y-2 mb-5"
          >
            ...
            <div v-show="isAuth">
              <MyButton @click="$router.push('/addhospital')"
                >Добавить</MyButton
              >
            </div>
          </div>
